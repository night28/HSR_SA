...
\subsubsection{Border BGP Konfiguration}
...
\subsubsection{IP Pools für Clients definieren}
...
Zum Schluss muss diese Konfiguration gespeichert werden. Damit diese auch aktiviert wird, muss der DHCP Service auf dem Infoblox neu gestartet werden. Infoblox weist jeweils darauf hin, wenn Änderungen einen Neustart der Services benötigen, das DNA Center leider nicht.
...
\end{tabular}
\caption[Erklärung der Host Onboarding Authentifizierungsmethoden]{Erklärung der Host Onboardning Authentifizierungsmethoden.\cite{ivan-caduff-slack}}


\subsubsection{Reporting einrichten}
