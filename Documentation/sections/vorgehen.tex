...
Folgende Ansicht ist unter \textit{Einstellungen (Zahnrad-Symbol) $\rightarrow$} Management zu finden:
...
\subsection{Farbic - Provisioning}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=5cm]{img/secondtry/dna-center-network-profile-new.png}
