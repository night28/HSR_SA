\section{Vorgehen Versuch 1} \label{versuch1}
...
\begin{table}[H]
	...
	\hline
	CLI - SCP      & Fehlgeschlagen (siehe \ref{fig:dna-center-provision-updates-2}) \\
	\hline
...
# -rw-r--r-- 1 1.3K May 17 09:09 apiserver.crt
...
# -r--r--r-- 1 1.1K May 17 08:49 ca.crt
# -rw-r--r-- 1 1.7K May 17 08:49 ca.key
# lrwxrwxrwx 1   23 May 17 08:49 ca-key.pem -> /etc/maglev/.pki/ca.crt
# lrwxrwxrwx 1   23 May 17 09:09 ca.pem -> /etc/maglev/.pki/ca.crt
# -r-------- 1 1.7K May 17 08:49 credentialmanager-key.pem
# -r-------- 1  307 May 21 06:20 credentialmanager-openssl.cnf
# -r--r--r-- 1 1.1K May 17 08:49 credentialmanager.pem
# -r-------- 1 1.7K May 17 08:49 encryptionmanager-key.pem
# -r-------- 1  307 May 21 06:20 encryptionmanager-openssl.cnf
# -r--r--r-- 1 1.1K May 17 08:49 encryptionmanager.pem
# -r-------- 1 1.7K May 17 08:49 encryption_seed-key.pem
# -r--r--r-- 1  981 May 17 08:49 encryption_seed.pem
...
# -r-------- 1 1.7K May 17 08:49 kong-key.pem
...
# -r-------- 1  336 May 21 06:20 kube-worker-1-openssl.cnf
...
# -r-------- 1   36 May 17 08:49 passphrase.txt
# -rw-r--r-- 1 1.1K May 21 06:20 registry-ca.pem
# -rw------- 1 1.7K May 17 09:09 sa.key
# -rw------- 1  451 May 17 09:09 sa.pub
\end{lstlisting}
