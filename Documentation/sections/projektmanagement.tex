...
\begin{figure}[H]
	\centering
	\includegraphics[height=5cm]{img/ZeitlichePlanung_v2.png}
...
\begin{longtable}{|m{0.5cm}|m{3cm}|m{5cm}|m{0.75cm}|m{0.75cm}|m{0.75cm}|m{5cm}|m{5cm}|} 
	...
	\hline\hline
	1 & Ausfall eines Teammitglieds & Ausfall auf Grund unvorhergesehener Ereignisse wie Krankheit, Unfall etc. & 40 & 15\% & 6 & Reserven einplanen, Kommunikation sicherstellen, sodass der Rest Aufgaben übernehmen kann & Tasks des ausgefallen Mitglieds möglichst auf den Rest des Teams aufteilen. \\ 
	\hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{p{1cm}| p{2.5cm}| X}
		...
		\hline	
		M0 & 27.02.2018 & Kickoff Meeting \\
		M1 & 03.04.2018 & Projektplanung abgeschlossen \\
