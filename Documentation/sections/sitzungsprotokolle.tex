...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{X | p{4.5cm}}
		...
		DNA Installationsvideo anschauen & Philipp, Sandro, Jessica \\
		Installationguide lesen & Philipp, Sandro, Jessica \\
		Use Cases FUB dokumentieren & Philipp, Sandro, Jessica \\	
...
\paragraph{Traktanden}
\begin{itemize}	
	\item Abgabe Abstract für Feedback
	\item Besprechung Abgabe Dokumente
	\item Aktueller Stand
\end{itemize}

\paragraph{Beschlüsse (Diskussion)}
\begin{itemize}	
	\item Abstract wird am 6. Juni 2018 an Betreuer gesendet, das Feedback gegeben werden kann
	\item Dokument und Plakat wird am 6. Juni an Betreuer zur Durchsicht gesendet
	\item Schwerpunkt bis Ende Arbeit auf UC01
\end{itemize}
...
\paragraph{Traktanden}
\begin{itemize}	
	\item Feedback für Dokument und Abstract
	\item Mittagessen nach Endpräsentation?
	\item Wünsche für Endpräsentation?
	\item Abgabe am Mittwoch wo?
\end{itemize}
...
\begin{itemize}	
	...
	\begin{itemize}
		\item Zur Zeit ist nur die Aufgabenstellung aus dem AVT => Initiale Aufgabenstellung... anhand der Ergebnisse wurden die Zielsetzungen angepasst, siehe Abstract.
	\end{itemize}
	\item Abstract
	\begin{itemize}
		\item Aufgabenstellung
		\begin{itemize}
			\item Controller (DNA Center) - Software-Defined Network Lösung im Campus
			\item Security ansprechen
			\item Gastzugang weg
			\item Benutzer- und Geräteprofile, Netzsegmentierung, Reporting, ...
			\item Vorgehen positiver darstellen
		\end{itemize}
		\item Vorgehen
		\begin{itemize}
			\item Die Konfiguration konnte erfolgreich vorgenomen werden.
			\item ISE und IOS => Dokumentation war nicht immer vorhanden, darum hat es mehr Zeit gekostet.
			\item In einem zweiten Schritt vom Overlay (Fabric) sprechen
		\end{itemize}
		\item Fazit
		\begin{itemize}
			\item SDA im Campus Bereich hat mit dem DNA Center hat sehr grosses Potenzial, es macht das Campus sicherer und vereinfacht die Umsetzung. In der aktuellen Version braucht es aber einigen Aufwand 
			\item Vision: API super, Netzwerk agil schnell konfigurierbar.. kann gute Qualität erreichen und Kosten einsparen
		\end{itemize}
	\end{itemize}
	\item Management Summary sehr gut
	\item Ausgangslage und Lösungskonzept streichen, da in Management Summary
	\item Technologien sehr gut
	\item Use Cases
	\begin{itemize}
		\item fehlende Use Cases noch ergänzen
		\item Use Cases beschreiben, auch wenn nur theoretische Informationen vorhanden
	\end{itemize}
	\item Vorgehen 1 und 2 interessant
	\item Ergebnis
	\begin{itemize}
		\item Bugs relativieren: in jeder Software gibt es Bugs
		\item API und Assurance herausheben
		\item Zukunft als Netzwerkingenieur nicht mehr nur Troubleshooting, sondern neu auch Design, Assurance und vieles mehr
	\end{itemize}
	\item Präsentation
	\begin{itemize}
		\item 7 Minuten Einleitung (kein genauer Vorgang)
		\item Use Cases vorstellen, auch wenn nicht umgesetzt und nur theoretisch
		\item Ergebnisdiskussion
		\item Projektplanung
		\item Zeitverlauf, Zeitmanagement
		\item Persönliches Feedback wird am Ende gefragt
	\end{itemize}
	\item Abgabe der Arbeit ca. um 16 Uhr (Herr Metzger ist bis 17 Uhr in der HSR)
\end{itemize}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{X | p{4.5cm}}
		...
		Präsentation vorbereiten & Philipp, Sandro, Jessica \\
	\end{tabularx}
	\label{tab:my-label}
\end{table}
