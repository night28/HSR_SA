...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{X | p{4.5cm}}
		...
		\textbf{Was} & \textbf{Verantwortlichkeit} \\
		\hline
		Netzwerk-Topologie anpassen & x \\
		DNA Installationsvideo anschauen & x \\
		Installationguide lesen & x \\
		Use Cases FUB dokumentieren & x \\	
		Testprotokolle für Use Case erstellen & x \\
	\end{tabularx}
	\label{tab:my-label}
\end{table}
